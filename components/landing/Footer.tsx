      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <Mountain className="h-8 w-8 text-primary-aqua" />
              <span className="text-xl font-bold">SlopeShift</span>
            </motion.div>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              The complete mountain resort operations platform. Unify every workflow from lift tickets to rentals in one modular, headless system.
            </motion.p>
        ...
        >
          <p className="text-gray-400 text-sm">
            © 2025 SlopeShift. All rights reserved.
          </p>
