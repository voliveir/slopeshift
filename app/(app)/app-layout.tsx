...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <CommandPaletteProvider>
      <ToastProvider>
        {/* Impersonation Banner - now full width at the very top */}
        {impersonating && impersonatedClientName && (
          <div className="p-4 bg-yellow-100 dark:bg-yellow-900 border-b border-yellow-400 dark:border-yellow-700 flex items-center justify-between shadow w-full z-50">
        ...
        <div className="flex h-[calc(100vh-0px)] bg-secondary-50 dark:bg-secondary-950">
          {/* Sidebar */}
          <Sidebar />
          {/* Main Content */}
