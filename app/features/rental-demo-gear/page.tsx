...
// Dummy screenshots
const screenshots = [
  "/demo/rental-inventory.png",
  "/demo/rental-techcard.png",
  "/demo/rental-kiosk.png",
];
...
const testimonials = [
  {
    quote:
      "SlopeShift's rental dashboard let us cut boot-fitting time in half and eliminate lost gear write-offs.",
    name: "Rental Manager, Snowbird",
    avatar: "/demo/avatar-snowbird.png",
    logo: "/demo/logo-snowbird.svg",
  },
  {
    quote:
      "Express pick-up kiosks are a guest favorite—our staff loves them too!",
    name: "Ops Lead, Alta Mountain",
    avatar: "/demo/avatar-alta.png",
    logo: "/demo/logo-alta.svg",
  },
  {
    quote:
      "Digital tech cards make compliance and tuning a breeze.",
    name: "Shop Tech, Whistler Blackcomb",
...
const kpis = [
  { value: "40%", label: "Faster Boot-Fitting" },
  { value: "18%", label: "Drop in Missing Gear Write-Offs" },
  { value: "9%", label: "Lift in Demo Upsells" },
];
...
const timeline = [
  {
    ...
    desc: "Guests pre-size and reserve gear from any device—no lines, no paper forms.",
  },
  {
    icon: (
    ...
    desc: "Guests check in at a kiosk; staff hand off pre-sized gear in seconds.",
  },
  {
    icon: (
    ...
    title: "On-Mountain Tracking",
    desc: "Barcode/RFID tags track every ski, board, and boot from wax room to return.",
  },
  {
    icon: (
    ...
    desc: "Auto-schedule work orders and log damage for every piece of gear.",
  },
];
...
export default function RentalDemoGearFeaturePage() {
    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="relative min-h-screen flex items-center justify-start overflow-hidden" style={{background: "linear-gradient(45deg, #0070F3 0%, #00D1B2 100%)"}}>
        ...
        <video
          ...
          src="/demo/rental-hero.mp4"
          poster="/demo/rental-hero.jpg"
          autoPlay
          loop
          muted
          playsInline
          preload="none"
          aria-label="Guests renting ski and demo gear"
          style={{ opacity: 0.32 }}
        />
        {/* Overlay gradient */}
        ...
        <div className="relative z-20 container mx-auto px-6 flex flex-col md:flex-row items-center min-h-screen">
          <div className="flex-1 flex flex-col justify-center items-start pt-32 md:pt-0">
            ...
            >
              One dashboard tracks every ski, board, and boot—from check-in to wax room to return.
            </motion.p>
      ...
      <section className="container mx-auto px-6 py-20 max-w-screen-xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            className="order-1"
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Smart Inventory</h2>
            <p className="text-lg text-gray-700 mb-6">
              Barcode/RFID tagging with live stock counts and maintenance flags. Never lose track of a ski, board, or boot again.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Live inventory & maintenance status</li>
              <li>Barcode/RFID scan for every item</li>
              <li>Multi-sport ready: bikes, skates, boards</li>
            </ul>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            ...
            className="order-2"
          >
            <DeviceFrame src={screenshots[0]} alt="Smart Inventory screenshot" />
          </motion.div>
        </div>
        {/* Block B */}
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <DeviceFrame src={screenshots[1]} alt="Digital Tech Card screenshot" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Digital Tech Cards</h2>
            <p className="text-lg text-gray-700 mb-6">
              DIN calculations, boot-sole length, and waiver signatures—all in one tap. No more handwritten forms.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Auto-calc DIN & boot-sole length</li>
              <li>Digital waiver signatures</li>
              <li>Instant tech card access for staff</li>
            </ul>
          </motion.div>
        </div>
        {/* Block C */}
        <div className="grid md:grid-cols-2 gap-12 items-center mb-8">
          <motion.div
            ...
            className="order-1"
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Express Pick-Up Kiosk</h2>
            <p className="text-lg text-gray-700 mb-6">
              Guests pre-size online; staff simply hand off gear. No more bottlenecks on powder days.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Self-service express kiosks</li>
              <li>Staff hand-off in seconds</li>
              <li>Auto-schedule maintenance & tuning</li>
            </ul>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            ...
            className="order-2"
          >
            <DeviceFrame src={screenshots[2]} alt="Express Pick-Up Kiosk screenshot" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-2xl">
          <div className="bg-gradient-to-br from-blue-600/90 to-teal-400/90 rounded-2xl shadow-xl p-10 flex flex-col items-center text-center">
            ...
            <p className="text-white/90 mb-8 text-lg max-w-md">
              See how SlopeShift can help you rent gear, not headaches. Request pricing or explore all modules.
            </p>
