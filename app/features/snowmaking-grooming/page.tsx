...
// Dummy screenshots
const screenshots = [
  "/demo/snowmaking-weather.png",
  "/demo/snowmaking-pumphouse.png",
  "/demo/snowmaking-gps.png",
];
...
const testimonials = [
  {
    quote:
      "SlopeShift's weather API and SCADA link let us run smarter, not harder.",
    name: "Snowmaking Lead, Aspen Snowmass",
    avatar: "/demo/avatar-aspen.png",
    logo: "/demo/logo-aspen.svg",
  },
  {
    quote:
      "Groomer GPS and shift planner make every night more efficient.",
    name: "Grooming Supervisor, Park City",
    avatar: "/demo/avatar-parkcity.png",
    logo: "/demo/logo-parkcity.svg",
  },
  {
    quote:
      "We cut compressor energy and machine hours—surface quality is up, costs are down.",
    name: "Mountain Ops, Whistler Blackcomb",
...
const kpis = [
  { value: "12%", label: "Energy Savings on Compressors" },
  { value: "20%", label: "Reduction in Machine Hours" },
  { value: "↑", label: "Guest Satisfaction Scores" },
];
...
const timeline = [
  {
    ...
    desc: "Live wet-bulb and wind forecasts flag optimal snowmaking windows.",
  },
  {
    icon: (
    ...
    title: "Pump House SCADA Link",
    desc: "Start/stop guns remotely, monitor flow & PSI from anywhere.",
  },
  {
    icon: (
    ...
    title: "Groomer GPS Trails",
    desc: "Heat-map coverage, fuel burn, and operator performance for every shift.",
  },
  {
    icon: (
    ...
    title: "Shift Planner & Snow Depth Sensors",
    desc: "Auto-generate routes, crews see tasks in-cab; sensors flag thin spots and reduce over-grooming.",
  },
];
...
export default function SnowmakingGroomingFeaturePage() {
    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="relative min-h-screen flex items-center justify-start overflow-hidden" style={{background: "linear-gradient(45deg, #0070F3 0%, #00D1B2 100%)"}}>
        ...
        <video
          ...
          src="/demo/snowmaking-hero.mp4"
          poster="/demo/snowmaking-hero.jpg"
          autoPlay
          loop
          muted
          playsInline
          preload="none"
          aria-label="Snowmaking and grooming in action"
          style={{ opacity: 0.32 }}
        />
        {/* Overlay gradient */}
        ...
        <div className="relative z-20 container mx-auto px-6 flex flex-col md:flex-row items-center min-h-screen">
          <div className="flex-1 flex flex-col justify-center items-start pt-32 md:pt-0">
            ...
            >
              Coordinate snowguns and groomers with weather-aware intelligence.
            </motion.p>
        ...
        {videoOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="bg-white rounded-2xl shadow-2xl p-4 max-w-2xl w-full relative">
              ...
              <video
                src="/demo/snowmaking-overview.mp4"
                poster="/demo/snowmaking-hero.jpg"
                controls
                autoPlay
      ...
      <section className="container mx-auto px-6 py-20 max-w-screen-xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            className="order-1"
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Weather API Integration</h2>
            <p className="text-lg text-gray-700 mb-6">
              Live wet-bulb and wind forecasts flag optimal snowmaking windows. No more guesswork.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Live wet-bulb & wind data</li>
              <li>Optimal snowmaking alerts</li>
              <li>Reduce wasted runs</li>
            </ul>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            ...
            className="order-2"
          >
            <DeviceFrame src={screenshots[0]} alt="Weather API screenshot" />
          </motion.div>
        </div>
        {/* Block B */}
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <DeviceFrame src={screenshots[1]} alt="Pump House SCADA screenshot" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Pump House SCADA Link</h2>
            <p className="text-lg text-gray-700 mb-6">
              Start/stop guns remotely, monitor flow & PSI. Run smarter, not harder.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Remote start/stop</li>
              <li>Monitor flow & PSI</li>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-8">
          <motion.div
            ...
            className="order-1"
          >
            <h2 className="text-2xl md:text-4xl font-semibold mb-4 text-blue-700">Groomer GPS Trails</h2>
            <p className="text-lg text-gray-700 mb-6">
              Heat-map coverage, fuel burn, and operator performance for every shift. More corduroy, less fuel.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>GPS heat-maps</li>
              <li>Operator performance</li>
              <li>Fuel & coverage analytics</li>
            </ul>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            ...
            className="order-2"
          >
            <DeviceFrame src={screenshots[2]} alt="Groomer GPS screenshot" />
          </motion.div>
        </div>
      </section>
